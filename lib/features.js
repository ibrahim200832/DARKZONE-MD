// Wires the anti-link, anti-spam and auto-reply handlers up to a Baileys
// socket's incoming-message stream. See example-connect.js for a runnable
// demo.
...
module.exports = { registerBotFeatures, handleAntiLink, handleAntiSpam, handleAutoReply };
